...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-[#000000] text-[#EDEDED] font-sans">
      ...
      <div className="flex flex-1 overflow-hidden p-2 gap-2 z-10">
        {/* Sidebar Navigation */}
        <aside className="w-14 flex flex-col items-center py-4 gap-4 bg-[#0A0A0A] rounded-xl border border-white/[0.08] shadow-sm">
          <div className="relative group">
            <button className="p-2.5 rounded-lg text-white hover:bg-white/[0.08] transition-colors active:scale-95">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
            </button>
            <div className="absolute left-full ml-3 px-2 py-1 bg-[#1A1A1A] text-[#EDEDED] text-xs font-medium rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap border border-white/[0.08] shadow-lg z-50">
              Explorer
            </div>
          </div>
          
          <div className="relative group">
            <button className="p-2.5 rounded-lg text-[#71717A] hover:text-[#EDEDED] hover:bg-white/[0.08] transition-colors active:scale-95">
        ...
        <main className="flex flex-col flex-1 overflow-hidden bg-[#0A0A0A] rounded-xl border border-white/[0.08] relative">
          
          {/* File Tab Header */}
          <div className="flex items-center h-10 border-b border-white/[0.08]">
            <div className="flex items-center gap-2 h-full px-4 border-r border-white/[0.08] bg-[#121212] cursor-pointer">
              <span className="text-white">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>
              </span>
              <span className="text-sm font-medium text-[#EDEDED] font-mono tracking-wide">main.py</span>
            </div>
          </div>
